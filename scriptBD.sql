...
INSERT IGNORE INTO `cliente` (`cliente_id`, `nombre`, `apellido`, `dni`, `telefono`, `edad`, `email`, `distrito`, `direccion`, `estado`) VALUES
	('CL001', 'Alejandro', 'Gonzales', '75897931', '972082374', 18, 'marquitos1213@hotmail.com', 'Santa Anita', 'Calle Los Olmos 123', 'activo'),
	('CL002', 'Andrea', 'Saavedra', '75897932', '915764235', 20, 'marquitos1213@hotmail.com', 'Ate', 'Calle Los Olmos 123', 'activo'),
	('CL003', 'Kike', 'Quispe', '75897933', '987456321', 23, 'marquitos1213@hotmail.com', 'Los Olivos', 'Calle Los Olmos 123', 'activo'),
	...
	('CL011', 'Kevin', 'Kuroki', '74716688', '996887199', 21, 'nprueba@homail.com', 'san borja', 'Calle Los Olivos 433', 'inactivo');
...
INSERT IGNORE INTO `comprobantepago` (`comprobantepago_id`, `venta_id`, `fecha`) VALUES
...
INSERT IGNORE INTO `detalle_promocion_producto` (`producto_id`, `promocion_id`) VALUES
	('PR001', 'PM001'),
	('PR002', 'PM002'),
	('PR003', 'PM003'),
	('PR004', 'PM004'),
...
-- Volcando datos para la tabla heroku_ba968b3eda52761.empleado: ~5 rows (aproximadamente)
/*!40000 ALTER TABLE `empleado` DISABLE KEYS */;
INSERT IGNORE INTO `empleado` (`empleado_id`, `nombre`, `dni`, `telefono`, `email`, `sueldo`, `direccion`, `id`, `contraseña`, `rol`) VALUES
	('E0001', 'Reinaldo', 'House', '25487615', 'aaaaa@gmail.com', 2000.00, 'Calle Los Olmos 123', 'aaaaa', '11111', 'admin'),
...
-- Volcando datos para la tabla heroku_ba968b3eda52761.pedido: ~16 rows (aproximadamente)
/*!40000 ALTER TABLE `pedido` DISABLE KEYS */;
INSERT IGNORE INTO `pedido` (`pedido_id`, `cliente_id`) VALUES
	('PE015', NULL),
	('PE001', 'CL001'),
	('PE002', 'CL001'),
	('PE003', 'CL001'),
...
INSERT IGNORE INTO `producto` (`producto_id`, `nombre`, `descripcion`, `cantidad`, `costo`) VALUES
...
-- Volcando datos para la tabla heroku_ba968b3eda52761.productopedido: ~13 rows (aproximadamente)
/*!40000 ALTER TABLE `productopedido` DISABLE KEYS */;
INSERT IGNORE INTO `productopedido` (`producto_id`, `pedido_id`, `cantidad`) VALUES
	('PR001', 'PE001', 3),
	('PR001', 'PE011', 7),
	('PR002', 'PE002', 3),
	('PR002', 'PE011', 20),
...
INSERT IGNORE INTO `promocion` (`promocion_id`, `nombre`, `descripcion`, `cantidad`, `producto_id`, `costo`) VALUES
...
INSERT IGNORE INTO `recarga` (`recarga_id`, `tarjeta_id`, `monto`) VALUES
	('RE001', 'TJ001', 100.00),
	('RE002', 'TJ001', 50.00),
	('RE003', 'TJ001', 120.00),
	('RE004', 'TJ002', 75.00),
...
INSERT IGNORE INTO `tarjeta` (`tarjeta_id`, `cliente_id`, `fechavencimiento`, `saldo`) VALUES
	('TJ001', 'CL001', '2001-09-20', 55.00),
	('TJ002', 'CL002', '2001-09-20', 16.00),
...
INSERT IGNORE INTO `ticket` (`ticket_id`, `recarga_id`, `fecha`) VALUES
...
-- Volcando datos para la tabla heroku_ba968b3eda52761.venta: ~12 rows (aproximadamente)
/*!40000 ALTER TABLE `venta` DISABLE KEYS */;
INSERT IGNORE INTO `venta` (`venta_id`, `pedido_id`, `descripcion`, `monto`, `fecha`) VALUES
	('VE', NULL, NULL, 0, '2020-09-17'),
