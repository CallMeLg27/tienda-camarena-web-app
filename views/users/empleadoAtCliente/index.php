...
<html lang="en">
    <head>
        ...
        <title>Atencion al cliente - Tienda Camarena</title>
                ...
                <div class="asd-spin-nested-loading text-center">
                    <div class="asd-spin-container">
                        <div class="container-fluid no-gutters paddingless-xl">
                            <div class="row"><div class="resultunit col-md-6 margin-bottom-15">
                                <article class="minimumunit">
                                    <a href="">
                                        <div class="minimumunitBody">
                                            <div class="minimumunitContainer">
                                                <img class="minimumunitLogo" src="public/img/tarjeta.png" th:src="@{public/img/tarjeta.png}" height="180" width="180" />
                                            </div>
                                            <h4 class="minimumunitTitle">Recargar tarjeta</h4> </br>
                                        </div>
                                    </a>
                                </article>
                            </div>
                            <div class="resultunit col-md-6 margin-bottom-15">
                                <article class="minimumunit">
                                    <a href="">
                                        <div class="minimumunitBody">
                                            <div class="minimumunitContainer">
                                                <img class="minimumunitLogo" src="public/img/clientes.png" th:src="@{public/img/clientes.png}" height="180" width="180" />
                                            </div>
                                            <h4 class="minimumunitTitle">Clientes</h4>  </br>
                                        </div>                   
                                    </a>
                                </article>
                            </div>
