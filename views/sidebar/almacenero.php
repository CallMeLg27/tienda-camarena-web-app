<div  id="sidebar-wrapper">
  ...
  <div class="list-group list-group-flush"> 
    ...
    <a href="http://localhost:8080/miproyecto/stockProductos" class="list-group-item list-group-item-action"  id="listStock"><i class=" fas fa-file"></i>  Consultar stock</a> 
    <a href="http://localhost:8080/miproyecto/crudpromocion" class="list-group-item list-group-item-action" id="listPromocion"><i class="fa fa-gift"></i>  Promociones</a>
  </div>
